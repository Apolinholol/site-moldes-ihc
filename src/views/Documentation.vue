<template>
  <section id="SectionDocumentacao" class="flex min-h-screen">
    ...
    <section id="SectionConteudoDocumentacao" class="flex-1 p-6 min-[576px]:ml-0">
      <div v-if="state.paginaAtiva === 0" class="prose max-w-none">
        ...
        <section>
          ...
          <ExemploCard titulo="#1: Visibilidade do Status do Sistema" descricao="O sistema deve sempre informar o usuário sobre o que está acontecendo.">
          ...
          <ExemploCard titulo="#2: Correspondência entre o Sistema e o Mundo Real">
            <template #descricao>O sistema deve falar a linguagem do usuário, não "tiopês" (linguagem técnica).</template>
        ...
        <section class="bg-yellow-50 p-6 rounded-lg border border-yellow-200">
          <ExemploCard titulo="#4: Consistência e Padrões" descricao="Os usuários não devem ter que se perguntar se palavras, situações ou ações diferentes significam a mesma coisa.">
          ...
          <ExemploCard titulo="#5: Prevenção de Erros" descricao="Melhor do que uma boa mensagem de erro é um design cuidadoso que evita que o problema ocorra.">
              <ExemploErro titulo="O Erro">
                <p class="text-sm text-gray-700 mb-2">
          ...
          <ExemploCard titulo="#6: Reconhecimento em vez de Memorização" descricao="Minimize a carga de memória do usuário tornando objetos, ações e opções visíveis.">
              <ExemploErro titulo="O Erro">
                <p class="text-sm text-gray-700 mb-2">
          ...
          <ExemploCard titulo="#7: Flexibilidade e Eficiência de Uso" descricao="Atalhos não vistos pelo usuário novato podem agilizar a interação para o usuário experiente.">
              <ExemploErro titulo="O Erro">
                <p class="text-sm text-gray-700 mb-2">
          ...
          <ExemploCard titulo="#8: Estética e Design Minimalista" descricao="Os diálogos não devem conter informações irrelevantes ou raramente necessárias.">
              <ExemploErro titulo="O Erro">
                <p class="text-sm text-gray-700 mb-2">
          ...
          <ExemploCard titulo="#9: Ajudar usuários a reconhecer erros" descricao="Mensagens de erro devem ser expressas em linguagem clara (sem códigos), indicar o problema e sugerir uma solução.">
              <ExemploErro titulo="O Erro">
          ...
          <ExemploCard titulo="#10: Ajuda e Documentação" descricao="Mesmo que o sistema seja intuitivo, pode ser necessário fornecer ajuda e documentação.">
              <ExemploErro titulo="O Erro">
                <p class="text-sm text-gray-700 mb-2">
    ...
    <section>
      ...
      <ExemploCard titulo="#1: Equilíbrio Visual (60-30-10)" descricao="Quanto mais cores utilizadas, mais complicado é alcançar o equilíbrio.">
      ...
      <ExemploCard titulo="#2: Semântica das Cores" descricao="As cores têm significado universal. O Vermelho cria urgência ; o Azul passa confiança e segurança.">
  ...
  <section>
    ...
    <ExemploCard titulo="#1: Categorização (Hick's Law)" descricao="Usuários subdividem opções em categorias e eliminam metade das opções a cada passo.">
    ...
    <ExemploCard titulo="#2: Lei de Miller (O número mágico 7±2)" descricao="A memória de curto prazo armazena apenas de 5 a 9 itens de informação.">
    ...
    <ExemploCard titulo="#3: Thumb Zones (Zonas do Polegar)" descricao="49% dos usuários interagem com o celular usando apenas uma mão (o polegar).">
  ...
  <div v-if="state.paginaAtiva === 3" class="prose max-w-none">
    <h1 class="text-3xl font-black text-black leading-tight w-fit fascinate-inline-regular mb-4"">Lei de Fitts</h1>
      ...
      <section>
        <ExemploCard titulo="#1: Tamanho e Área de Clique" descricao="Botões maiores são mais rápidos de clicar e têm menos chance de erro.">
        ...
        <ExemploCard titulo="#2: Dificultando Ações Perigosas" descricao="Para dificultar uma ação, diminua o alvo e aumente a distância.">
        ...
        <ExemploCard titulo="#3: Bordas da Tela (Otimização)">
          <template #descricao>As bordas da tela têm "altura infinita", pois o mouse para lá automaticamente.</template>
  ...
  <div v-if="state.paginaAtiva === 4" class="prose max-w-none">
    <h1 class="text-3xl font-black text-black leading-tight w-fit fascinate-inline-regular mb-4"">Princípios de Gestalt</h1>
      ...
      <section>
        <ExemploCard titulo="#1: Proximidade" descricao="Tendemos a agrupar elementos que estão próximos uns dos outros como uma unidade.">
        ...
        <ExemploCard titulo="#2: Semelhança" descricao="Percebemos elementos como pertencentes ao mesmo grupo se eles se parecerem (cor, forma, tamanho).">
        ...
        <ExemploCard titulo="#3: Continuidade" descricao="Elementos alinhados dão a sensação de seguir uma direção. O olho prefere seguir um caminho suave.">
        ...
        <ExemploCard titulo="#4: Fechamento & Pregnância" descricao="O cérebro completa informações faltando (Fechamento) e prefere formas simples e rápidas de ler (Pregnância).">
  ...
  <div v-if="state.paginaAtiva === 5" class="prose max-w-none">
    ...
    <section>
      ...
      <ExemploCard titulo="#1: Legibilidade e Família Tipográfica" descricao="A clareza dos caracteres é vital para evitar erros de interpretação.">
      ...
      <ExemploCard titulo="#2: Contraste e Acessibilidade (WCAG)" descricao="O texto deve ser legível para todos, independentemente do fundo.">
      ...
      <ExemploCard titulo="#3: Hierarquia Visual e Escaneabilidade" descricao="O uso de pesos e tamanhos diferentes ajuda o usuário a processar a informação por ordem de importância.">
      ...
      <ExemploCard titulo="#4: Ritmo Vertical e Espaçamento" descricao="O espaço entre as linhas (entrelinha) influencia diretamente a velocidade de leitura e o conforto visual.">
  ...
  <div v-if="state.paginaAtiva === 6" class="prose max-w-none">
    <section class="prose max-w-none">
      ...
      <p class="text-lg text-gray-700">
        ...
        auditivas, motoras, cognitivas), possam perceber, entender, navegar e interagir com o conteúdo. Não é um extra,
    ...
    <section>
      ...
      <ExemploCard titulo="#1: Imagens sem Descrição (Texto Alternativo)" descricao="Leitores de tela para deficientes visuais dependem do atributo 'alt' para descrever o conteúdo de uma imagem.">
          ...
          <ExemploSolucao titulo="A Solução (Imagem Descrita)">
            <p class="text-sm text-gray-700 mb-4">
              O atributo 'alt' deve ser conciso e descrever a essência da imagem. Se a imagem for puramente decorativa,
              use 'alt=""'.
            </p>
            <ExemploPreview tipo="solucao" class="p-4 text-center">
              <img src="https://thumbs.dreamstime.com/b/costa-tropical-do-oceano-paisagem-20517527.jpg"
              ...
              <code
                class="text-xs text-green-700 mt-2 text-center">&lt;img src="..." alt="Rochas na beira do mar com pequenas ondas."&gt;</code>
            </ExemploPreview>
          </ExemploSolucao>
        </ExemploCard>

      <ExemploCard titulo="#2: Controles Não Acessíveis via Teclado">
        <template #descricao>Muitos usuários navegam usando apenas o teclado. Elementos clicáveis devem ser "focáveis" e "acionáveis" com teclas como 'Tab' e 'Enter'.</template>
      ...
      <ExemploCard titulo="#3: Formulários sem Rótulos (Labels)">
        ...
        <template #descricao>A tag <code>&lt;label&gt;</code> associa um texto descritivo a um campo de formulário, permitindo que leitores de tela anunciem a finalidade do campo e que o clique no rótulo foque no campo.</template>
          <ExemploErro titulo="O Erro (Rótulo Visual Apenas)">
            <p class="text-sm text-gray-700 mb-4">
              Um texto ao lado de um campo não o associa semanticamente. Leitores de tela anunciam "campo de edição" sem
      ...
      <ExemploCard titulo="#4: HTML Não Semântico">
        ...
        <template #descricao>O uso de tags HTML apropriadas (<code>&lt;nav&gt;</code>, <code>&lt;main&gt;</code>, <code>&lt;header&gt;</code>) cria "marcos" na página que ajudam usuários de leitores de tela a navegar rapidamente.</template>
          <ExemploErro titulo="O Erro (Sopa de Divs)">
            <p class="text-sm text-gray-700 mb-4">
              Estruturar a página inteira com <code>&lt;div&gt;</code> impede que tecnologias assistivas identifiquem a
...
&lt;footer&gt;...&lt;/footer&gt;
      ...
      <ExemploCard titulo="#5: Contraste de Cores Insuficiente" descricao="Textos com baixo contraste em relação ao fundo são difíceis de ler para pessoas com baixa visão ou daltonismo. A WCAG recomenda um contraste mínimo de 4.5:1 para texto normal.">
          <ExemploErro titulo="O Erro (Baixo Contraste)">
            <p class="text-sm text-gray-700 mb-4">
      ...
      <ExemploCard titulo="#6: Texto Não Redimensionável" descricao="Usuários com baixa visão precisam aumentar o tamanho do texto no navegador. Se o layout quebrar ou o texto ficar cortado, a página se torna inutilizável.">
          ...
          <ExemploSolucao titulo="A Solução (Unidades Relativas e Layout Fluido)">
            <p class="text-sm text-gray-700 mb-4">
              Use unidades relativas como 'rem' para fontes e evite alturas fixas em contêineres de texto. O layout deve
      ...
      <ExemploCard titulo="#7: Links Não Descritivos">
        <template #descricao>Usuários de leitores de tela frequentemente navegam pulando de link em link. Links como "clique aqui" ou "saiba mais" não oferecem contexto sobre o destino.</template>
      ...
      <ExemploCard titulo="#8: Gerenciamento de Foco Incorreto" descricao="Ao abrir ou fechar elementos dinâmicos, como modais, o foco do teclado deve ser gerenciado para proporcionar uma experiência de navegação lógica.">
          <ExemploErro titulo="O Erro (Foco Perdido)">
            <p class="text-sm text-gray-700 mb-4">
              Após fechar um modal, o foco volta para o topo da página, forçando o usuário a navegar por tudo novamente
              ...
              <Transition name="fade">
                <div v-if="state.h8ModalErroAberto"
                  ...
                  <div class="bg-white rounded-lg shadow-xl p-6 w-full max-w-sm mx-4 space-y-4">
                    ...
                    <p class="text-sm text-gray-600">Este modal <strong>não prende o foco</strong>. Pressione TAB e veja
          ...
          <ExemploSolucao titulo="A Solução (Foco Preso e Restaurado)">
            ...
            <p class="text-xs text-green-700 mt-2 text-center">Clique para abrir o modal e veja que foco ficará preso e
      ...
      <ExemploCard titulo="#9: Idioma da Página Não Declarado">
        ...
        <template #descricao>O atributo <code>lang</code> na tag <code>&lt;html&gt;</code> informa aos leitores de tela qual o idioma do conteúdo, garantindo a pronúncia correta das palavras.</template>
          <ExemploErro titulo="O Erro (Idioma Ausente)">
            <p class="text-sm text-gray-700 mb-4">
              Sem o atributo <code>lang</code>, um leitor de tela configurado em inglês tentará ler o texto em português
      ...
      <ExemploCard titulo="#10: Conteúdo Dinâmico Não Anunciado" descricao="Quando um conteúdo muda dinamicamente na tela (ex: uma mensagem de erro ou de sucesso), usuários de leitores de tela precisam ser notificados da mudança.">
