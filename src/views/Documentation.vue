    ...
    <section id="SectionConteudoDocumentacao" class="flex-1 p-6 min-[576px]:ml-0 bg-yellow-50">
      <div v-if="state.paginaAtiva === 0" class="prose max-w-none">
        <section class="prose max-w-none">
          ...
          <p class="merriweather-body text-lg text-gray-700 leading-relaxed">
          ...
          <div
            ...
            <!-- text-2xl font-black mb-6 leading-tight w-fit fascinate-inline-regular -->
            <h3 class="text-blue-900 font-black text-lg leading-tight w-fit fascinate-inline-regular">Por que são importantes?</h3>
            <p class="merriweather-body text-lg text-blue-800 mt-2 leading-relaxed">
        ...
        <!-- text-3xl font-black text-black leading-tight w-fit fascinate-inline-regular mb-4 -->
        <section class="bg-yellow-300 p-6 border-4 border-black mt-6 p-4 my-6 shadow-[6px_6px_0_0_rgba(0,0,0,0.85)]">

          <h2 class="text-2xl font-black mb-6 leading-tight w-fit fascinate-inline-regular">Erros Comuns VS Boas Práticas</h2>
          ...
          <ExemploCard titulo="#1: Visibilidade do Status do Sistema"
            ...
            <ExemploErro titulo="O Erro (Sem Feedback)">
              <p class="merriweather-body text-base text-gray-800 mb-2 leading-relaxed">
          ...
          <ExemploCard titulo="#10: Ajuda e Documentação"
            ...
            <ExemploErro titulo="O Erro">
              ...
              <ExemploPreview tipo="erro" class="p-4 text-center">
                ...
                <div class="mt-2 text-[10px] bg-gray-50 text-gray-500 px-3 py-1 rounded inline-block">Baixar PDF
                </div>
              </ExemploPreview>
            </ExemploErro>
            <ExemploSolucao titulo="A Solução">
      ...
      <div v-if="state.paginaAtiva === 1" class="prose max-w-none">
        ...
        <section class="prose max-w-none">
         <p class="merriweather-body text-lg text-gray-700 leading-relaxed">
          ...
          <div
            ...
            <h3 class="text-indigo-900 font-black text-lg leading-tight w-fit fascinate-inline-regular">A Regra de Ouro: 60-30-10</h3>
            <p class="merriweather-body text-indigo-800 mt-2 text-lg leading-relaxed">
              Para garantir equilíbrio visual, utilize a proporção:
            </p>
            <ul class="list-disc pl-5 mt-2 text-indigo-800 font-medium merriweather-body leading-relaxed">
              <li>
                <strong class="font-black">60% Cor Dominante:</strong> Geralmente neutra (Fundo, espaços em branco).
              </li>
              <li><strong class="font-black">30% Cor Secundária:</strong> Identidade da marca (Menus, Cabeçalhos).</li>
              <li>
                <strong class="font-black">10% Cor de Destaque (Accent):</strong> Para chamadas para ação (Botões,
                Links).
              </li>
            </ul>
          </div>
          ...
          <div
            class="bg-blue-200 p-6 border-4 border-blue-900 mt-6 p-4 my-6 border-2 border-black shadow-[6px_6px_0_0_rgba(0,0,0,0.85)]">
            <h3 class="text-blue-900 font-black text-lg leading-tight w-fit fascinate-inline-regular">Por que é importante?</h3>
            <p class="merriweather-body text-lg text-blue-800 mt-2 leading-relaxed">
        ...
        <section class="bg-yellow-300 p-6 border-4 border-black mt-6 p-4 my-6 shadow-[6px_6px_0_0_rgba(0,0,0,0.85)]">
          ...
          <ExemploCard titulo="#3: Conforto Visual (O Mito do Preto)">
            <template #descricao>Evite usar 100% Black. É uma cor que domina todo o redor.</template>
          ...
          <div
            class="bg-indigo-200 p-6 border-4 border-indigo-900 mt-6 p-4 my-6 border-2 border-black shadow-[6px_6px_0_0_rgba(0,0,0,0.85)]">
            <h3 class="text-indigo-900 font-black text-lg leading-tight w-fit fascinate-inline-regular mb-4">Paleta Sugerida para Escolas:</h3>
          ...
          <ExemploCard titulo="#3: Thumb Zones (Zonas do Polegar)"
            ...
            <ExemploErro titulo="O Erro (Topo da Tela)">
              ...
              <ExemploPreview tipo="erro" class="p-4 font-semibold text-red-600">
                <div class="w-32 h-48 bg-gray-50 border-4 border-gray-800 rounded mx-auto relative">
                  <div
            ...
            <ExemploErro titulo="O Erro (Espaçamento Igual)">
              ...
              <ExemploPreview tipo="erro" class="p-4 flex flex-col gap-4">
                ...
                <input type="text" value="..." disabled
                  class="bg-gray-50 p-1 w-full border border-gray-300 rounded text-sm text-gray-700" />
            ...
            <ExemploErro titulo="O Erro (Quebra de Fluxo)">
              ...
              <ExemploPreview tipo="erro" class="p-4 space-y-3">
                <div>
                  ...
                  <input type="text" value="João" disabled
                    class="bg-gray-50 p-1 w-1/2 border border-gray-300 rounded text-sm text-gray-700" />
                </div>
                <div class="text-right">
                  <label class="text-xs text-gray-500 block mb-0.5 text-right">Turma:</label>
                  <input type="text" value="3B" disabled
                    class="bg-gray-50 p-1 w-1/2 ml-auto block border border-gray-300 rounded text-sm text-gray-700 text-right" />
                </div>
                <div class="text-center">
                  <label class="text-xs text-gray-500 block mb-0.5">Status:</label>
                  <input type="text" value="Ativo" disabled
                    class="bg-gray-50 p-1 w-1/2 mx-auto block border border-gray-300 rounded text-sm text-gray-700 text-center" />
                </div>
              </ExemploPreview>
            </ExemploErro>
