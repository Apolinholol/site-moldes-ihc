    ...
    <section>
      ...
      <div class="mb-10 border border-gray-200 rounded-lg overflow-hidden shadow-sm">
        <div class="bg-gray-100 p-3 border-b border-gray-300">
          ...
          <p class="text-sm text-gray-500 m-0">
            Leitores de tela para deficientes visuais dependem do atributo 'alt' para descrever o conteúdo de uma
            imagem.
          </p>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-2">
      ...
      <div class="mb-10 border border-gray-200 rounded-lg overflow-hidden shadow-sm">
        <div class="bg-gray-100 p-3 border-b border-gray-300">
          ...
          <p class="text-sm text-gray-500 m-0">
            Muitos usuários navegam usando apenas o teclado. Elementos clicáveis devem ser "focáveis" e "acionáveis" com
            teclas como 'Tab' e 'Enter'.
          </p>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-2">
      ...
      <div class="mb-10 border border-gray-200 rounded-lg overflow-hidden shadow-sm">
        <div class="bg-gray-100 p-3 border-b border-gray-300">
          ...
          <p class="text-sm text-gray-500 m-0">
            A tag <code>&lt;label&gt;</code> associa um texto descritivo a um campo de formulário, permitindo que
            leitores de tela anunciem a finalidade do campo e que o clique no rótulo foque no campo.
          </p>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-2">
...
&lt;footer&gt;...&lt;/footer&gt;
      ...
      <div class="mb-10 border border-gray-200 rounded-lg overflow-hidden shadow-sm">
        <div class="bg-gray-100 p-3 border-b border-gray-300">
          ...
          <p class="text-sm text-gray-500 m-0">
            Textos com baixo contraste em relação ao fundo são difíceis de ler para pessoas com baixa visão ou
            daltonismo. A WCAG recomenda um contraste mínimo de 4.5:1 para texto normal.
          </p>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-2">
          <ExemploErro titulo="O Erro (Baixo Contraste)">
      ...
      <div class="mb-10 border border-gray-200 rounded-lg overflow-hidden shadow-sm">
        <div class="bg-gray-100 p-3 border-b border-gray-300">
          ...
          <p class="text-sm text-gray-500 m-0">
            Usuários com baixa visão precisam aumentar o tamanho do texto no navegador. Se o layout quebrar ou o texto
            ficar cortado, a página se torna inutilizável.
          </p>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-2">
      ...
      <div class="mb-10 border border-gray-200 rounded-lg overflow-hidden shadow-sm">
        <div class="bg-gray-100 p-3 border-b border-gray-300">
          ...
          <p class="text-sm text-gray-500 m-0">
            Usuários de leitores de tela frequentemente navegam pulando de link em link. Links como "clique aqui" ou
            "saiba mais" não oferecem contexto sobre o destino.
          </p>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-2">
      ...
      <div class="mb-10 border border-gray-200 rounded-lg overflow-hidden shadow-sm">
        <div class="bg-gray-100 p-3 border-b border-gray-300">
          ...
          <p class="text-sm text-gray-500 m-0">
            Ao abrir ou fechar elementos dinâmicos, como modais, o foco do teclado deve ser gerenciado para proporcionar
            uma experiência de navegação lógica.
          </p>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-2">
      ...
      <div class="mb-10 border border-gray-200 rounded-lg overflow-hidden shadow-sm">
        <div class="bg-gray-100 p-3 border-b border-gray-300">
          ...
          <p class="text-sm text-gray-500 m-0">
            O atributo <code>lang</code> na tag <code>&lt;html&gt;</code> informa aos leitores de tela qual o idioma do
            conteúdo, garantindo a pronúncia correta das palavras.
          </p>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-2">
      ...
      <div class="mb-10 border border-gray-200 rounded-lg overflow-hidden shadow-sm">
        <div class="bg-gray-100 p-3 border-b border-gray-300">
          ...
          <p class="text-sm text-gray-500 m-0">
            Quando um conteúdo muda dinamicamente na tela (ex: uma mensagem de erro ou de sucesso), usuários de leitores
            de tela precisam ser notificados da mudança.
          </p>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-2">
