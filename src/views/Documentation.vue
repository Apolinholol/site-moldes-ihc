<template>
  <section id="SectionDocumentacao" class="merriweather-body flex min-h-screen bg-yellow-50">
    <div
    ...
    <Teleport to="body">
      <Transition name="fade">
        ...
        >
          ✓ Salvo com sucesso!
          <button
            @click="state.h1ToastVisivel = false"
      ...
      <Transition name="fade">
        ...
        >
          ...
          <button
            @click="state.h3ToastVisivel = false"
            class="ml-2 text-white hover:text-gray-200 font-bold text-lg leading-none cursor-pointer"
            aria-label="Fechar"
          >
            ✕
    ...
    <section id="SectionConteudoDocumentacao" class="flex-1 p-6 min-[576px]:ml-0">
      <div v-if="state.paginaAtiva === 0" class="prose max-w-none">
        <section class="prose max-w-none">
          <h1
            class="text-3xl font-black text-black leading-tight w-fit fascinate-inline-regular mb-4"
          >
        ...
        <section
          class="bg-yellow-50 p-6 border-3 border-yellow-900 mt-6 p-4 my-6 shadow-[3px_3px_0_0_rgba(0,0,0,1)]"
        >
            ...
            <ExemploSolucao titulo="A Solução">
              ...
              <ExemploPreview tipo="solucao" class="p-4 text-center flex justify-center">
                <button
                  ...
                  :class="{
                    'bg-blue-600 hover:bg-blue-700 cursor-pointer':
                      !state.h1Salvando && !state.h1Salvo,
                ...
                >
                  ...
                  <span v-else-if="state.h1Salvando" class="flex items-center gap-2"
                    ><span class="animate-spin">⟳</span> Salvando...</span
                  >
          ...
          <ExemploCard titulo="#2: Correspondência entre o Sistema e o Mundo Real">
            <template #descricao
              >O sistema deve falar a linguagem do usuário, não "tiopês" (linguagem
              técnica).</template
            >
          ...
          <ExemploCard titulo="#3: Controle e Liberdade do Usuário">
            <template #descricao
              >O usuário erra. Ele precisa de uma "saída de emergência" clara.</template
            >
            ...
            <ExemploSolucao titulo="A Solução">
              ...
              <ExemploPreview tipo="solucao" class="p-4 text-center">
                ...
                <div v-else-if="state.h3EtapaModal === 1" class="space-y-3">
                  <p class="text-sm text-gray-700 font-semibold m-0">
                    Tem certeza que deseja gerar o relatório completo?
                  </p>
                ...
                <div
                  v-else
                  class="text-green-600 font-semibold flex items-center justify-center gap-2"
                >
          ...
          >
            <ExemploErro titulo="O Erro">
              <p class="text-sm text-gray-700 mb-2">
                Na tela de Alunos, o botão de salvar é verde e diz "Salvar". Na tela de Professores,
                o botão é azul e diz "Persistir Dados".
              </p>
          ...
          >
            <ExemploErro titulo="O Erro">
              <p class="text-sm text-gray-700 mb-2">
                Permitir que a secretária digite data em qualquer formato num campo de texto livre.
              </p>
            ...
            <ExemploSolucao titulo="A Solução">
              <p class="text-sm text-gray-700 mb-2">
                Usar máscaras de input para impedir formatos inválidos. Apenas números são aceitos e
          ...
          >
            <ExemploErro titulo="O Erro">
              <p class="text-sm text-gray-700 mb-2">
                Para lançar notas, o professor precisa clicar em "Editar", clicar no campo, digitar,
                clicar em "Salvar", repetir para 40 alunos.
              </p>
              <ExemploPreview tipo="erro" class="p-3 text-sm space-y-2">
                <div v-for="i in 3" :key="'h7err' + i" class="flex items-center gap-2">
                  ...
                  <span
                    class="border border-gray-300 w-full p-1 text-gray-300 rounded bg-gray-50 text-xs"
                    >Nome do aluno</span
                  >
                  <button
                    class="text-[10px] bg-gray-200 text-gray-500 px-2 py-0.5 rounded border border-gray-300 whitespace-nowrap cursor-default"
                  >
                    Editar
                  </button>
                  <button
              ...
              <p class="text-xs text-red-500 mt-2 text-center">
                3 cliques por aluno × 40 alunos = 120 cliques
              </p>
            </ExemploErro>
            <ExemploSolucao titulo="A Solução">
              <p class="text-sm text-gray-700 mb-2">
                Permitir navegação com a tecla "TAB" entre os campos de nota e salvamento automático
                ao sair do campo.
              </p>
              <ExemploPreview tipo="solucao" class="p-3 text-sm space-y-2">
                <div v-for="(_, i) in 3" :key="i" class="flex items-center gap-2">
                  ...
                  <input
                    :ref="
                      (el) => {
                        h7Refs[i] = el as HTMLInputElement | null
                      }
                    "
                    v-model="state.h7Notas[i]"
                    type="text"
                    :placeholder="
                      i < 2 ? 'Digite a nota e pressione TAB' : 'Digite a nota e pressione TAB'
                    "
                ...
                <p class="text-[10px] text-gray-400 text-center m-0 pt-1 font-mono">
                  [TAB] Navega entre alunos
                </p>
              </ExemploPreview>
            </ExemploSolucao>
          </ExemploCard>
          ...
          >
            ...
            <ExemploSolucao titulo="A Solução">
              ...
              <ExemploPreview tipo="solucao" class="p-3 text-sm space-y-2">
                <div
                  class="flex items-center gap-2 p-2 bg-yellow-100 border border-yellow-200 rounded"
                >
                ...
                <div
                  class="flex items-center gap-2 p-2 bg-emerald-100 border border-green-200 rounded"
                >
                  <span class="text-lg">✅</span>
                  <div>
          ...
          <ExemploCard
            titulo="#9: Ajudar usuários a reconhecer erros"
          ...
          >
            <ExemploErro titulo="O Erro">
              ...
              <p class="text-xs text-red-500 mt-2 text-center">(O usuário não sabe o que errou)</p>
            </ExemploErro>
            <ExemploSolucao titulo="A Solução">
          ...
          >
            <ExemploErro titulo="O Erro">
              ...
              <ExemploPreview tipo="erro" class="p-4 text-center">
                ...
                <div
                  class="mt-2 text-[10px] bg-gray-100 text-gray-500 px-3 py-1 rounded inline-block"
                >
                  Baixar PDF
                </div>
              </ExemploPreview>
      ...
      <div v-if="state.paginaAtiva === 1" class="prose max-w-none">
        ...
        <section class="prose max-w-none">
          ...
          >
            ...
            <p class="m-0 text-blue-800 mt-2 font-medium">
              Ajuda a criar interfaces visualmente agradáveis, organizadas e fáceis de entender. O
              uso correto das cores melhora a legibilidade, destaca informações importantes e
              orienta o usuário na navegação da interface. Além disso, cores bem escolhidas podem
              transmitir emoções, reforçar identidade visual e melhorar a acessibilidade.
            </p>
          </div>
          <div
            class="bg-blue-200 p-6 border-3 border-blue-900 mt-6 p-4 my-6 border-2 border-black shadow-[3px_3px_0_0_rgba(0,0,0,1)]"
        ...
        >
          ...
          <ExemploCard
            titulo="#1: Equilíbrio Visual (60-30-10)"
          ...
          >
            <ExemploErro titulo="O Erro (Carnaval Visual)">
              <p class="text-sm text-gray-700 mb-4">
                Usar uma cor diferente para cada botão ou seção sem hierarquia, cansando a vista do
                professor.
              </p>
              <ExemploPreview tipo="erro" class="p-4 space-y-2">
                ...
                <button
                  class="w-full bg-red-500 text-white py-1 rounded transition-colors duration-150 hover:bg-red-600 cursor-pointer"
                >
                  Botão 1
                </button>
                <button
                  class="w-full bg-yellow-400 text-black py-1 rounded transition-colors duration-150 hover:bg-yellow-500 cursor-pointer"
                >
                  Botão 2
                </button>
              </ExemploPreview>
          ...
          >
            <ExemploErro titulo="O Erro (Sinais Trocados)">
              ...
              <ExemploPreview tipo="erro" class="p-4 text-center gap-2 flex justify-center">
                ...
                <button
                  class="bg-green-600 text-white px-4 py-2 rounded transition-colors duration-150 hover:bg-green-700 cursor-pointer"
                >
                  Apagar Tudo
                </button>
              </ExemploPreview>
          ...
          <ExemploCard titulo="#3: Conforto Visual (O Mito do Preto)">
            <template #descricao
              >"Evite usar o 100% Black. É uma cor que domina todo o redor."</template
            >
            <ExemploErro titulo="O Erro (Contraste Duro)">
              <p class="text-sm text-gray-700 mb-2">
                Texto preto puro (#000000) em fundo branco puro (#FFFFFF). O contraste extremo cansa
                a vista em leituras longas.
              </p>
      ...
      <div v-if="state.paginaAtiva === 2" class="prose max-w-none">
        ...
        <section>
          ...
          >
            <h3 class="text-blue-900 font-black text-lg m-0">Por que é importante ?</h3>
            <p class="m-0 text-blue-800 mt-2 font-medium">
              Em IHC, essa lei é importante para orientar o design de menus e interfaces,
        ...
        >
          ...
          <ExemploCard
            titulo="#1: Categorização (Hick's Law)"
          ...
          <ExemploCard
            titulo="#2: Lei de Miller (O número mágico 7±2)"
          ...
          <ExemploCard
            titulo="#3: Thumb Zones (Zonas do Polegar)"
      ...
      <div v-if="state.paginaAtiva === 3" class="prose max-w-none">
        ...
        <section>
          ...
          >
            <h3 class="text-blue-900 font-black text-lg m-0">Por que é importante ?</h3>
            <p class="m-0 text-blue-800 mt-2 font-medium">
              Ela ajuda a definir o tamanho e posicionamento de elementos interativos, garantindo
              que botões e controles sejam fáceis e rápidos de selecionar, melhorando a usabilidade
              da interface.
            </p>
          </div>
          <div
        ...
        >
          <h2 class="text-2xl font-bold mb-6">Erros Comuns VS Boas Práticas</h2>
          <ExemploCard
            titulo="#1: Tamanho e Área de Clique"
          ...
          >
            <ExemploErro titulo="O Erro (Alvo Minúsculo)">
              ...
              <div
                class="flex justify-center items-center h-20 border-red-400 border-2 bg-white rounded"
              >
            ...
            <ExemploSolucao titulo="A Solução (Área Expandida)">
              ...
              <div
                class="flex justify-center items-center h-20 border-emerald-400 border-2 bg-white rounded"
              >
                <button
          ...
          <ExemploCard titulo="#3: Bordas da Tela (Otimização)">
            <template #descricao
              >As bordas da tela têm "altura infinita", pois o mouse para lá
              automaticamente.</template
            >
            <ExemploErro titulo="O Erro (Menu Flutuante)">
              <p class="text-sm text-gray-700 mb-2">
                Deixar um menu importante "boiando" no meio da tela. O usuário precisa desacelerar o
                mouse para acertar o alvo.
              </p>
              <ExemploPreview tipo="erro" class="h-32 w-full relative">
                <div
                  class="absolute top-10 left-10 bg-slate-100 p-2 shadow border rounded cursor-default group/menu"
                >
                  <span class="text-lg text-gray-700 cursor-pointer">Menu</span>
                  <div
                    class="hidden group-hover/menu:block mt-1 border-t border-gray-300 pt-1 space-y-1"
                  >
                    <div class="text-[10px] text-gray-500 hover:text-gray-800 cursor-pointer">
                      Início
                    </div>
                    <div class="text-[10px] text-gray-500 hover:text-gray-800 cursor-pointer">
                      Alunos
            ...
            <ExemploSolucao titulo="A Solução (Cantos e Bordas)">
              <p class="text-sm text-gray-700 mb-2">
                Fixar menus no topo ou na lateral esquerda. O usuário pode "jogar" o mouse sem medo
                de passar do ponto.
              </p>
              <div
                class="bg-gray-200 h-32 w-full relative border-2 border-emerald-400 overflow-hidden rounded"
              >
                <!-- Barra de navegação no topo -->
                <div
                  class="absolute top-0 left-0 w-full bg-blue-800 h-8 shadow flex items-center px-2 gap-3"
                >
                ...
                <!-- Sidebar lateral -->
                <div
                  class="absolute top-8 left-0 h-full w-16 bg-white border-r border-gray-300 pt-2 space-y-2 px-1"
                >
        ...
        <section
          class="bg-indigo-200 p-6 border-3 border-indigo-900 mt-6 p-4 my-6 shadow-[3px_3px_0_0_rgba(0,0,0,1)]"
        >
      ...
      <div v-if="state.paginaAtiva === 4" class="prose max-w-none">
        ...
        >
          <h3 class="text-blue-900 font-black text-lg m-0">Por que é importante ?</h3>
          <p class="m-0 text-blue-800 mt-2 font-medium">
            Tem como objetivo ajudar na estruturação layouts de forma clara e intuitiva, utilizando
            conceitos como proximidade, similaridade, continuidade e fechamento, facilitando a
            compreensão das informações e a navegação do usuário.
          </p>
        </div>
        <section
          class="bg-yellow-50 p-6 border-3 border-yellow-900 mt-6 p-4 my-6 shadow-[3px_3px_0_0_rgba(0,0,0,1)]"
        >
          ...
          >
            <ExemploErro titulo="O Erro (Espaçamento Igual)">
              <p class="text-sm text-gray-700 mb-4">
                Quando o título, o campo e o botão têm o mesmo espaçamento, o usuário não sabe o que
                pertence a quê.
              </p>
          ...
          >
            <ExemploErro titulo="O Erro (Inconsistência)">
              ...
              <ExemploPreview tipo="erro" class="p-4 flex gap-3 justify-center items-center">
                <span class="text-blue-600 underline cursor-pointer hover:text-blue-800"
                  >Alunos</span
                >
                <button class="bg-gray-200 px-2 rounded hover:bg-gray-300 cursor-pointer">
                  Turmas
                </button>
          ...
          >
            <ExemploErro titulo="O Erro (Quebra de Fluxo)">
              <p class="text-sm text-gray-700 mb-2">
                Alinhamento em zigue-zague. O olho do professor tem que pular pela tela para ler os
                dados.
              </p>
            ...
            <ExemploSolucao titulo="A Solução (Alinhamento)">
              <p class="text-sm text-gray-700 mb-2">
                Alinhar tudo à esquerda (padrão ocidental de leitura) cria uma linha imaginária que
                guia o olhar.
              </p>
          ...
          <ExemploCard
            titulo="#4: Fechamento & Pregnância"
          ...
          >
            ...
            <ExemploSolucao titulo="A Solução (Simplicidade)">
              ...
              <div
                class="bg-white h-16 flex items-center justify-center border-emerald-400 border-2"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="w-8 h-8 text-gray-700 cursor-pointer hover:text-gray-900"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  stroke-width="1.5"
      ...
      <div v-if="state.paginaAtiva === 5" class="prose max-w-none">
        ...
        >
          ...
          <ExemploCard
            titulo="#1: Legibilidade e Família Tipográfica"
          ...
          <ExemploCard
            titulo="#2: Contraste e Acessibilidade (WCAG)"
          ...
          <ExemploCard
            titulo="#3: Hierarquia Visual e Escaneabilidade"
          ...
          >
            ...
            <ExemploSolucao titulo="A Solução (Pesos e Contraste)">
              ...
              <ExemploPreview tipo="solucao" class="p-4">
                <p class="text-xl font-bold text-black m-0 uppercase mb-1">Título do Módulo</p>
          ...
          <ExemploCard
            titulo="#4: Ritmo Vertical e Espaçamento"
            ...
            <ExemploSolucao titulo="A Solução (Respiro Visual)">
              ...
              <ExemploPreview tipo="solucao" class="p-4">
                <p class="text-sm text-gray-800 m-0 leading-relaxed">
                  A tipografia em IHC foca na experiência do usuário final. Quando as linhas possuem
                  um espaçamento adequado, a leitura se torna natural e o aprendizado é facilitado.
                </p>
              </ExemploPreview>
            </ExemploSolucao>
          </ExemploCard>
      ...
      <div v-if="state.paginaAtiva === 6" class="prose max-w-none">
        <section class="prose max-w-none">
          ...
          <p class="text-lg text-gray-700">
            Acessibilidade na web significa garantir que todas as pessoas, incluindo aquelas com
            deficiências (visuais, auditivas, motoras, cognitivas), possam perceber, entender,
            navegar e interagir com o conteúdo. Não é um extra, mas um pilar fundamental do design
          ...
          >
            <h3 class="text-blue-900 font-black text-lg m-0">Por que é importante?</h3>
            <p class="m-0 text-blue-800 mt-2 font-medium">
              Um sistema acessível expande seu público, melhora a experiência de todos os usuários
              (não apenas os com deficiência), fortalece a imagem da marca e, em muitos países, é
              uma exigência legal.
            </p>
          </div>
        </section>
        ...
        >
          ...
          <ExemploCard
            titulo="#1: Imagens sem Descrição (Texto Alternativo)"
          ...
          >
            <ExemploErro titulo="O Erro (Imagem Silenciosa)">
              <p class="text-sm text-gray-700 mb-4">
                Uma imagem sem o atributo 'alt' é invisível para leitores de tela. O usuário ouve
                apenas "imagem" ou o nome do arquivo, perdendo todo o contexto.
              </p>
              <ExemploPreview tipo="erro" class="p-4 text-center">
                <!-- <img src="https://thumbs.dreamstime.com/b/costa-tropical-do-oceano-paisagem-20517527.jpg" -->
                <img src="../assets/computadores.jpg" class="h-24 mx-auto" />
                <code class="text-xs text-red-500 mt-2 text-center">&lt;img src="..."&gt;</code>
              </ExemploPreview>
            </ExemploErro>
            <ExemploSolucao titulo="A Solução (Imagem Descrita)">
              <p class="text-sm text-gray-700 mb-4">
                O atributo 'alt' deve ser conciso e descrever a essência da imagem. Se a imagem for
                puramente decorativa, use 'alt=""'.
              </p>
              <ExemploPreview tipo="solucao" class="p-4 text-center">
                <img
                  src="../assets/computadores.jpg"
                  alt="Rochas na beira do mar com pequenas ondas."
                  class="h-24 mx-auto"
                />
                <code class="text-xs text-green-700 mt-2 text-center"
                  >&lt;img src="..." alt="Vários computadores dentro de uma sala de aula"</code
                >
              </ExemploPreview>
            </ExemploSolucao>
          </ExemploCard>
          ...
          <ExemploCard titulo="#2: Controles Não Acessíveis via Teclado">
            <template #descricao
              >Muitos usuários navegam usando apenas o teclado. Elementos clicáveis devem ser
              "focáveis" e "acionáveis" com teclas como 'Tab' e 'Enter'.</template
            >
            <ExemploErro titulo="O Erro (Div Clicável)">
              <p class="text-sm text-gray-700 mb-4">
                Uma '&lt;div&gt;' com evento de clique não pode ser alcançada com a tecla 'Tab' por
                padrão, excluindo usuários de teclado.
              </p>
              <ExemploPreview tipo="erro" class="p-4 text-center">
                <div
                  class="bg-blue-600 text-white py-2 px-4 rounded inline-block cursor-pointer hover:bg-blue-700"
                >
                  Salvar (Não acessível)
                </div>
              </ExemploPreview>
              <p class="text-xs text-red-500 mt-2 text-center">
                Tente alcançar este "botão" usando a tecla TAB.
              </p>
            </ExemploErro>
            <ExemploSolucao titulo="A Solução (Botão ou Atributos ARIA)">
              <p class="text-sm text-gray-700 mb-4">
                Use o elemento '&lt;button&gt;' sempre que possível. Se precisar usar uma
                '&lt;div&gt;', adicione 'tabindex="0"', 'role="button"' e um evento de teclado.
              </p>
              <ExemploPreview tipo="solucao" class="p-4 text-center">
                <button
              ...
              <p class="text-xs text-green-700 mt-2 text-center">
                Este botão é focável e acionável pelo teclado.
              </p>
            </ExemploSolucao>
          </ExemploCard>
          ...
          <ExemploCard titulo="#3: Formulários sem Rótulos (Labels)">
            <template #descricao
              >A tag <code>&lt;label&gt;</code> associa um texto descritivo a um campo de
              formulário, permitindo que leitores de tela anunciem a finalidade do campo e que o
              clique no rótulo foque no campo.</template
            >
            <ExemploErro titulo="O Erro (Rótulo Visual Apenas)">
              <p class="text-sm text-gray-700 mb-4">
                Um texto ao lado de um campo não o associa semanticamente. Leitores de tela anunciam
                "campo de edição" sem explicar o que deve ser preenchido.
              </p>
              <ExemploPreview tipo="erro" class="p-4">
              ...
              <p class="text-xs text-red-500 mt-2 text-center">
                Este campo não está associado a um rótulo semântico.
              </p>
            </ExemploErro>
            <ExemploSolucao titulo="A Solução (Uso de 'for' e 'id')">
              <p class="text-sm text-gray-700 mb-4">
                O atributo <code>for</code> da label deve corresponder ao <code>id</code> do input,
                criando uma conexão clara. Clicar no rótulo agora foca no campo.
              </p>
              <ExemploPreview tipo="solucao" class="p-4">
              ...
              <p class="text-xs text-green-700 mt-2 text-center">
                Clique no rótulo 'Nome' para focar no campo.
              </p>
            </ExemploSolucao>
          </ExemploCard>
          ...
          <ExemploCard titulo="#4: HTML Não Semântico">
            <template #descricao
              >O uso de tags HTML apropriadas (<code>&lt;nav&gt;</code>, <code>&lt;main&gt;</code>,
              <code>&lt;header&gt;</code>) cria "marcos" na página que ajudam usuários de leitores
              de tela a navegar rapidamente.</template
            >
            <ExemploErro titulo="O Erro (Sopa de Divs)">
              <p class="text-sm text-gray-700 mb-4">
                Estruturar a página inteira com <code>&lt;div&gt;</code> impede que tecnologias
                assistivas identifiquem a estrutura e a finalidade de cada bloco.
              </p>
            ...
            <ExemploSolucao titulo="A Solução (Estrutura Clara)">
              <p class="text-sm text-gray-700 mb-4">
                Tags como <code>&lt;header&gt;</code>, <code>&lt;main&gt;</code> e
                <code>&lt;footer&gt;</code> definem a estrutura da página, permitindo uma navegação
                mais eficiente.
              </p>
          ...
          <ExemploCard
            titulo="#5: Contraste de Cores Insuficiente"
          ...
          >
            <ExemploErro titulo="O Erro (Baixo Contraste)">
              <p class="text-sm text-gray-700 mb-4">
                Um texto cinza claro sobre um fundo branco pode parecer "elegante", mas é ilegível
            ...
            <ExemploSolucao titulo="A Solução (Contraste Adequado)">
              <p class="text-sm text-gray-700 mb-4">
                Use cores que garantam uma taxa de contraste adequada. Ferramentas online podem
                ajudar a verificar o contraste.
              </p>
              <ExemploPreview tipo="solucao" class="p-4 text-center">
          ...
          <ExemploCard
            titulo="#6: Texto Não Redimensionável"
          ...
          >
            <ExemploErro titulo="O Erro (Fontes em 'px' e Layout Fixo)">
              <p class="text-sm text-gray-700 mb-4">
                Usar pixels (px) para fontes e ter um layout com alturas fixas pode fazer com que o
                texto transborde ou se sobreponha quando o usuário aumenta o zoom.
              </p>
              <div
                class="bg-white p-4 border-red-400 border-2 rounded overflow-hidden"
                style="height: 50px"
              >
                <p style="font-size: 16px">
                  Este texto pode ficar cortado se você aumentar o zoom.
                </p>
              </div>
            </ExemploErro>
            <ExemploSolucao titulo="A Solução (Unidades Relativas e Layout Fluido)">
              <p class="text-sm text-gray-700 mb-4">
                Use unidades relativas como 'rem' para fontes e evite alturas fixas em contêineres
                de texto. O layout deve se adaptar ao conteúdo.
              </p>
              <ExemploPreview tipo="solucao" class="p-4">
          ...
          <ExemploCard titulo="#7: Links Não Descritivos">
            <template #descricao
              >Usuários de leitores de tela frequentemente navegam pulando de link em link. Links
              como "clique aqui" ou "saiba mais" não oferecem contexto sobre o destino.</template
            >
            <ExemploErro titulo="O Erro (Links Genéricos)">
              ...
              <ExemploPreview tipo="erro" class="p-4">
                <p class="text-sm text-gray-800">
                  Para ver o relatório de notas,
                  <a href="#" class="text-blue-600 underline">clique aqui</a>.
                </p>
              </ExemploPreview>
            </ExemploErro>
            <ExemploSolucao titulo="A Solução (Links com Contexto)">
              <p class="text-sm text-gray-700 mb-4">
                O próprio texto do link deve descrever a ação ou o destino, tornando a navegação
                mais clara e eficiente.
              </p>
              <ExemploPreview tipo="solucao" class="p-4">
                <p class="text-sm text-gray-800">
                  Acesse o
                  <a href="#" class="text-blue-600 underline">relatório de notas de 2024</a>.
                </p>
              </ExemploPreview>
            </ExemploSolucao>
          </ExemploCard>
          ...
          <ExemploCard
            titulo="#8: Gerenciamento de Foco Incorreto"
          ...
          >
            <ExemploErro titulo="O Erro (Foco Perdido)">
              <p class="text-sm text-gray-700 mb-4">
                Após fechar um modal, o foco volta para o topo da página, forçando o usuário a
                navegar por tudo novamente para voltar onde estava.
              </p>
              <ExemploPreview tipo="erro" class="p-4 text-center">
                <button
                  @click="h8AbrirModalErro"
                  class="bg-blue-600 text-white px-4 py-2 rounded transition-colors duration-150 hover:bg-blue-700 cursor-pointer"
                >
                  Abrir Modal (Errado)
                </button>
              ...
              <p class="text-xs text-red-500 mt-2 text-center">
                Clique para abrir o modal e veja que ao fechar, o foco se perde.
              </p>

              <Teleport to="body">
                <Transition name="fade">
                  <div
                    v-if="state.h8ModalErroAberto"
                  ...
                  >
                    <div class="bg-white rounded-lg shadow-xl p-6 w-full max-w-sm mx-4 space-y-4">
                      ...
                      <p class="text-sm text-gray-600">
                        Este modal <strong>não prende o foco</strong>. Pressione TAB e veja que o
                        foco sai do modal. Ao fechar, o foco vai para o topo da página.
                      </p>
                      <input
                        type="text"
            ...
            <ExemploSolucao titulo="A Solução (Foco Preso e Restaurado)">
              <p class="text-sm text-gray-700 mb-4">
                O foco deve ser "preso" dentro do modal enquanto ele estiver aberto. Ao fechar, o
                foco deve retornar programaticamente para o elemento que o abriu (o botão, por
                exemplo).
              </p>
              <ExemploPreview tipo="solucao" class="p-4 text-center">
                <button
                  ref="h8BtnAbrirSolucao"
                  @click="h8AbrirModalSolucao"
                  class="bg-blue-600 text-white px-4 py-2 rounded transition-colors duration-150 hover:bg-blue-700 cursor-pointer"
                >
                  Abrir Modal (Correto)
                </button>
              ...
              <p class="text-xs text-green-700 mt-2 text-center">
                Clique para abrir o modal e veja que foco ficará preso e retornará a este botão ao
                fechar.
              </p>
              ...
              <Teleport to="body">
                <Transition name="fade">
                  <div
                    v-if="state.h8ModalSolucaoAberto"
                    class="fixed inset-0 bg-black/50 flex items-center justify-center z-[99999]"
                    role="dialog"
                    aria-modal="true"
                    aria-label="Modal com foco gerenciado"
                    @click.self="h8FecharModalSolucao"
                  >
                    <div
                      ref="h8ModalSolucaoRef"
                    ...
                    >
                      ...
                      <p class="text-sm text-gray-600">
                        O foco está <strong>preso aqui dentro</strong>. Pressione TAB e veja que ele
                        circula apenas entre os elementos do modal. Ao fechar, o foco volta ao botão
                        que abriu.
                      </p>
                      <input
                        type="text"
          ...
          <ExemploCard titulo="#9: Idioma da Página Não Declarado">
            <template #descricao
              >O atributo <code>lang</code> na tag <code>&lt;html&gt;</code> informa aos leitores de
              tela qual o idioma do conteúdo, garantindo a pronúncia correta das palavras.</template
            >
            <ExemploErro titulo="O Erro (Idioma Ausente)">
              <p class="text-sm text-gray-700 mb-4">
                Sem o atributo <code>lang</code>, um leitor de tela configurado em inglês tentará
                ler o texto em português com sotaque e pronúncia em inglês, tornando-o
                incompreensível.
              </p>
              <ExemploPreview tipo="erro" class="p-2 text-xs text-gray-500 font-mono">
                <p>&lt;html&gt;...&lt;/html&gt;</p>
            ...
            <ExemploSolucao titulo="A Solução (Idioma Declarado)">
              <p class="text-sm text-gray-700 mb-4">
                Declarar o idioma principal da página é uma das otimizações de acessibilidade mais
          ...
          <ExemploCard
            titulo="#10: Conteúdo Dinâmico Não Anunciado"
          ...
          >
            <ExemploErro titulo="O Erro (Mudança Silenciosa)">
              <p class="text-sm text-gray-700 mb-4">
                Uma mensagem de "Salvo com sucesso!" aparece na tela, mas como não é focada, o
                usuário com deficiência visual não sabe que a ação foi concluída.
              </p>
              <ExemploPreview tipo="erro" class="p-4">
            ...
            <ExemploSolucao titulo="A Solução (ARIA Live Regions)">
              <p class="text-sm text-gray-700 mb-4">
                Usando atributos como <code>aria-live="polite"</code> ou <code>role="alert"</code>,
                o leitor de tela anunciará a nova mensagem assim que ela aparecer na tela, sem mover
                o foco do usuário.
              </p>
              <ExemploPreview tipo="solucao" class="p-2 text-xs text-gray-600 font-mono">
