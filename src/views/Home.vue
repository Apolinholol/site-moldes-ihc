<template>
            ...
            <div>
                <div class="mb-6 flex gap-4 flex-wrap flex-col">
                    ...
                    <div class="inline-block bg-white 
                                px-6 py-3 shadow-[4px_4px_0_0] h-[fit-content] w-fit"
                                style=" border: 2px solid black;
                                        padding: 8px;
                                        background-color: rgba(255, 255, 255, 0.589);
                                        box-shadow: #000 4px 4px 0 0;">
                        <span class="text-4xl leading-tight font-black texto-sombra-padrao
        ...
        <section id="SectionDetalhes" class="px-4 pb-8"
                ...
                <section id="SectionConteudoDetalhes" class="flex justify-between flex-wrap gap-8 mt-6">
                    <div>
                        <p class="text-3xl font-black
                         text-black mb-6 border-b-4 border-black pb-4">
                         Detalhes do Projeto
                        </p>
                    </div>
                    <div style="max-width: 22rem;">
                         <article class="border-4 border-black bg-white shadow-[6px_6px_0_0_rgba(0,0,0,1)]">
                            <div class="bg-black px-6 py-4 border-b-4 border-black">
                                <h2 class="text-2xl font-black text-yellow-300 uppercase tracking-wider">Integrantes</h2>
                            </div>
